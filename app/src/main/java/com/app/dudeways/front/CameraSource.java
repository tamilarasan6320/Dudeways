package com.app.dudeways.front;
...
public class CameraSource {
    ...
    public synchronized CameraSource start() throws IOException {
        ...
        camera = createCamera(requestedPreviewWidth, requestedPreviewHeight);
     ...
     */
    @SuppressLint("InlinedApi")
    private Camera createCamera(int previewWidth, int previewHeight) throws IOException {
        ...
        SizePair sizePair = selectSizePair(camera, previewWidth, previewHeight);
        if (sizePair == null) {
